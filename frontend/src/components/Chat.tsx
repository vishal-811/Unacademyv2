...
export const ChatComponent = () => {
  ...
  return (
    <div className="relative bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl shadow-lg h-full">
  <AnimatePresence>
    <motion.div
    ...
    >
      {/* Chat Header */}
      <h2 className="text-xl font-semibold text-gray-800 backdrop-blur-3xl 
  ...
  {/* Chat Input Section */}
  <div className="absolute bottom-0 left-0 w-full flex items-center space-x-3 p-4 bg-gray-50 border-t border-gray-200 rounded-xl">
    <input
      value={msg}
